package com.cms.authentication.utilities;
...
public class Constants {
    ...
    public static final String VENDOR_MESSAGE_DESCRIPTION_INVALID_USER_ACCOUNT = "Invalid User Account.";
    ...
    public static final String REQUIRED_EMAIL = "Field email required.";
    public static final String REQUIRED_EMAIL_NOT_EMPTY = "Field email should not be empty.";
    public static final String REQUIRED_EMAIL_INVALID = "Field email is invalid.";
